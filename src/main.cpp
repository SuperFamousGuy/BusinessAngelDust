...
uint256 hashGenesisBlock("0xaa3f5b5a4fa7bc455d8e5379e7cd1611ef94046bb5c84eea15b5ff681fcc2ab4");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // BusinessAngelDust: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "BusinessAngelDust Signed Message:\n";
...
{
    // BusinessAngelDust: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // BusinessAngelDust: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // BusinessAngelDust: 3.5 days
static const int64 nTargetSpacing = 150; // BusinessAngelDust: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BusinessAngelDust: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BusinessAngelDust: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // BusinessAngelDust: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x77d8125a70f732683be9ef343e84a16086d5caf6143fc52846b469f5f22f3aa1");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("ac61e06a795bbd3a97758d260960684c614dde938ef602f75069d62d02c68a5f968667120ada7de3c04c0565f188e57e8d66cc85e6e06afd46143ab7f067c0f12e") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1469902617;
        block.nBits    = 504365644;
        block.nNonce   = 2697661104;

        if (fTestNet)
        {
            block.nTime    = 1469902617;
            block.nNonce   = 544399686;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x594d7b9834b40ebd61715e4032e2423d17f1f3581fde80cbc84d9065bea5ee0a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // BusinessAngelDust: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("BusinessAngelDust RPCMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BusinessAngelDustMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BusinessAngelDustMiner : ProcessBlock, block not accepted");
    }
